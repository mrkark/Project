...
int main() {
    ...
    cout << "Введите день недели на английском с маленькой буквы (понедельник-monday; вторник-tuesday; среда-wednesday; четверг-thursday; пятница-friday; суббота-saturday)" << endl;
    cin >> WeekDay;

    cout << "Введите номер недели (1,2) если в расписании нет деления на недели(вторник, среда, суббота) введите 1" << endl;
    cin >> WeekNum;
